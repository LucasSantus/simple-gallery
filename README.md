...
_"Criar um projeto simples relacionado a galeria estilo [ Pinterest ] utilizando CSS Column para a exibição de imagens."_
...
Este projeto está licenciado sob a Licença MIT License - veja o [LICENSE.md](https://github.com/LucasSantus/simple-gallery/blob/master/LICENSE) para melhores detalhes.
